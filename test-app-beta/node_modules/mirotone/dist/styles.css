...
.button:nth-child(n) {
  margin: 0px calc(8px * 2) calc(8px * 2) 0px;
  margin: 0px var(--space-small) var(--space-small) 0px;
}
...
.button-primary:enabled:active {
  border-color: rgba(61, 81, 212, 1);
  border-color: var(--blue900);
  background-color: rgba(61, 81, 212, 1);
  background-color: var(--blue900);
}

.button-primary.focus-visible::before {
  border: 2px solid rgba(61, 81, 212, 1);
  border: 2px solid var(--blue900);
  box-shadow: 0 0 0 calc(8px / 2) rgba(217, 224, 255, 1);
...
.button-secondary:focus {
  border-color: rgba(240, 240, 243, 1);
...
.button-secondary:enabled:active {
  border-color: rgba(235, 235, 239, 1);
...
.button-secondary.focus-visible::before {
  border: 2px solid rgba(155, 153, 175, 1);
  border: 2px solid var(--indigo500);
  box-shadow: 0 0 0 calc(8px / 2) rgba(205, 204, 215, 1);
...
.button-danger {
  color: rgba(255, 255, 255, 1);
  color: var(--white);
  border-color: rgba(217, 41, 41, 1);
  border-color: var(--red700);
  background-color: rgba(217, 41, 41, 1);
...
.button-danger.focus-visible::before {
  border: 2px solid rgba(217, 41, 41, 1);
  border: 2px solid var(--red700);
  box-shadow: 0 0 0 calc(8px / 2) rgba(247, 212, 212, 1);
...
.checkbox:nth-child(n) {
  margin: 0px 0px calc(8px * 2) 0px;
  margin: 0px 0px var(--space-small) 0px;
}

.checkbox span {
  margin: 0 0 0 calc(8px * 3);
...
.input:focus {
  border-color: rgba(104, 129, 255, 1);
...
.success div.status-text {
  ...
  font-size: 12px;
  font-size: var(--font-size-small);
  color: rgba(119, 204, 102, 1);
  color: var(--green700);
}

.success input.input {
  border-color: rgba(119, 204, 102, 1);
...
.icon-pen {
  background-image: url("data:image/svg+xml;charset=utf8,%3Csvg width='24' height='24' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cg clip-path='url(%23clip0_105_2572)' stroke='%23050038' stroke-width='2'%3E%3Cpath d='M13.41 2.803L19 18.176V24a1 1 0 01-1 1H6a1 1 0 01-1-1v-5.824l5.59-15.373c.479-1.317 2.341-1.317 2.82 0zM8.571 9h6.858'/%3E%3C/g%3E%3Cdefs%3E%3CclipPath id='clip0_105_2572'%3E%3Cpath fill='%23fff' d='M0 0h24v24H0z'/%3E%3C/clipPath%3E%3C/defs%3E%3C/svg%3E");
}
...
.link.link-primary {
  ...
  color: var(--blue700);
  border-bottom-color: rgba(217, 224, 255, 1);
...
.link.link-primary-light {
  ...
  color: var(--blue600);
  border-bottom-color: rgba(104, 129, 255, 1);
...
.link.link-danger {
  color: rgba(217, 41, 41, 1);
  color: var(--red700);
  border-bottom-color: rgba(225, 84, 84, 1);
...
.link.link-text {
  color: rgba(95, 92, 128, 1);
  color: var(--indigo600);
  border-bottom-color: rgba(95, 92, 128, 1);
...
.toggle.focus-visible span::before {
  box-shadow: 0 0 0 calc(8px / 2) rgba(217, 224, 255, 1);
  box-shadow: 0 0 0 var(--border-radius-medium) var(--blue400);
}
